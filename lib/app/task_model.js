...
module.exports = function createTaskModel(connection, maxAge) {
  ...
  var Schema = mongoose.Schema({
    ...
    recepient_types: [{ type: String, default: null}],
    conditional_queries: [{ type: String, default: null}],
    data: {
      JSON_Data: { type: String, default: null },
      image_filepath: [{ type: String, default: null }],
