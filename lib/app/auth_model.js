...
var Schema = mongoose.Schema({
  ...
  staff2: {
    role_id: [{ type: Number, default: 5}],
    alias: [{ type: String, default: null}]
  },
  staff3: {
    role_id: [{ type: Number, default: 6}],
    alias: [{ type: String, default: null}]
  },
  staff4: {
    role_id: [{ type: Number, default: 7}],
    alias: [{ type: String, default: null}]
  },
  staff5: {
    role_id: [{ type: Number, default: 8}],
    alias: [{ type: String, default: null}]
  },
  basic_user: {
  ...
  client: {
    role_id: [{ type: Number, default: 11}],
    alias: [{ type: String, default: null}]
  },
  potential_client: {
    role_id: [{ type: Number, default: 12}],
    alias: [{ type: String, default: null}]
  },
  shareholder: {
    role_id: [{ type: Number, default: 13}],
    alias: [{ type: String, default: null}]
  },
  vendor: {
    role_id: [{ type: Number, default: 14}],
    alias: [{ type: String, default: null}]
  },
  government_agent: {
    role_id: [{ type: Number, default: 15}],
    alias: [{ type: String, default: null}]
  },
  regulatory_agent: {
    role_id: [{ type: Number, default: 16}],
    alias: [{ type: String, default: null}]
  }
    ...
    get: function() {
      ...
      var seed_Data = function(){
        ...
        function seedData(data){
          ...
          permissions_data.government_agent.role_id = data.government_agent1.role_id;
          permissions_data.government_agent.alias = data.government_agent1.alias;
          permissions_data.regulatory_agent.role_id = data.regulatory_agent1.role_id;
          permissions_data.regulatory_agent.alias = data.regulatory_agent1.alias;
