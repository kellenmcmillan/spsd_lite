    ...
    home_page_configs: [
      {
        ...
        primary_slideshow_hero: {
          slides: [
            {
              landscape_src: {type: String, default: null},
              type: {type: String, default: null},
              ...
              no_text_content: {type: Boolean, default: null}
            }
          ],
              ...
              items: [
                {
                  ...
                  thumb_image_src: {type: String, default: null},
                  type: {type: String, default: null},
                  alt: {type: String, default: null}
                }
              ]
    ...
    get: function() {
      ...
      var seed_Data = function(){
        ...
        function seedData(data){
          ...
          appData.portfolio_page_configs = data.portfolio_page_configs;
