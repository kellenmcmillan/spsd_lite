...
$http){
    ...
    var app_relationship = determine_app_relationship(); 

    // creates initial click path entry
    clickpath.push($location.path());
    // creates initial click path entry

    // On page changes, log event
    $rootScope.$on('$locationChangeSuccess', function() {
        ...
        if(app_is_loaded == true){
            ...
            $rootScope.save_event_object({
                "clickpath": clickpath, 
                "user_id": $rootScope.me ? $rootScope.me.id : undefined,
                "user_ip": ip_for_events, 
                "payload": undefined,
                "timestamp": Date.now(), 
                "page": $location.path(), 
                "action": undefined,
    ...
    $rootScope.click_event = function(e){
        ...
        e.user_id = $rootScope.me ? $rootScope.me.id : undefined;
        e.user_ip = ip_for_events;
