...
$http){
    ...
    this.download_images = function(arg){
        var image_source = arg.source.split('https://storage.googleapis.com/spsd-189118.appspot.com/media/images/').pop();
        firebaseStorage.ref().child('media/images').child(image_source).getDownloadURL()
        .then(function(url){
            $rootScope.image_download = url;
            $timeout(function(){
                $rootScope.$broadcast('server-event', {
                    data:{
                        message: "Image " + arg.metadata.name + " Downloaded."
                    }
                });
            },  500);
        });
...
$http){
    ...
    $scope.dynamic_task_message_variables = ["First Name", "Last Name", "Email", "Password", "Phone", "My First Name", "My Last Name", "My Email", "My Phone", "Appointment", "Product/Service", "Message", "Lead Details", "Receipt", "Resource", "case"];
    ...
    var lightweight_log = function(e){
