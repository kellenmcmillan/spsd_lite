...
$window){
    ...
    this.log_events = function(arg, argAction){
        ...
        if (argAction == "set"){
            ...
            var lightweight_event = angular.fromJson(result);
...
$http){
    ...
    var clickpath = [];
    var user_id_for_events = $rootScope.me ? $rootScope.me.id : null;
    var session = {};
    var ip_for_events;
    var flags = [];
    var auth_state_for_events = $rootScope.me ? "signed-in" : "anonymous";
    var typeOfUser;
    if ($rootScope.me){
    ...
    function is_coordinator(){
        var result = $rootScope.me.security.roles == "Lightweight Internet Coordinator" ? true : false;
        return result;
    }
    function getIP(){
        var result;
    ...
    flags.push(
        {"auth_state": auth_state_for_events}, 
        {"auth_relationship": typeOfUser}, 
        {"locked_out": false}, 
        {"timed_out": false}, 
        {"is_coordinator": is_coordinator()}
    );

    // sets initial default event object
    ...
    // creates initial default event object
    ...
    $rootScope.app_trigger_types = ["action", "page-visit", "inactive", "account"];
