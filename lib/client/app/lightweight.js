...
$http){
    ...
    this.put_task = function(arg){
        ...
        function compileMonth(e,n){console.log("Compile Month Working");var t={},a=e-1,r=new Date(n,e,0).getDate(),o=new Date(n,a,1);return t.date=o,t.year=n,t.number_of_days=r,t.month_number=a,t}
        function compileMonthAlg(e){console.log("Compile Month Alg Working");for(var a=0,n=[],r=1;r<=e.number_of_days;r++){var t={};t.day=getDayOfWeek(r,e.month_number,e.year),t.date=new Date(e.year,e.month_number,r),t.milliseconds=Date.parse(t.date),t.day_number=r,t.week=a,n.push(t),t.day>5&&a++}return n};
        function checkIfNextYear(e){return e>12};
        function runtimeAlg(){console.log("Run Time Alg Working");var t,e=new Date,o=(Date.now(),e.getDay(),e.getDate(),e.getMonth()),n=e.getFullYear(),h=o+1,a=h+1,i=n+1,l=checkIfNextYear(a),c=compileMonth(h,n);t=!0===l?compileMonth(1,i):compileMonth(a,n),this_month=compileMonthAlg(c),next_month=compileMonthAlg(t)};
        // functions that help compute next runtime
...
$http){
    ...
    $scope.dynamic_task_message_variables = ["First Name", "Last Name", "Email", "Password", "Phone", "My First Name", "My Last Name", "My Email", "My Phone", "Appointment", "Product/Service", "Message", "Lead Details", "Receipt", "Resource"];
    ...
    $rootScope.view_galleries = false;
    $rootScope.view_media = true;
    $rootScope.view_tags = false;
    $rootScope.view_upload = false;

    $rootScope.switchMediaViews = function(view){
        ...
        switch(view){
            case "media":
                ...
                break;
            case "galleries":
                $rootScope.view_galleries = true;
                $rootScope.view_media = false;
                $rootScope.view_tags = false;
                $rootScope.view_upload = false;
                break;
            case "tags":
