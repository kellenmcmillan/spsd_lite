...
$http){
    ...
    $rootScope.addFolderItem = function(){
        ...
        $rootScope.mediavault_filepicker($rootScope.selected_folder.items[$rootScope.selected_folder.items.length - 1].source);
        $rootScope.folders_view = "edit folder item";
        $rootScope.folder_item = $rootScope.selected_folder.items[$rootScope.selected_folder.items.length - 1];
    }
