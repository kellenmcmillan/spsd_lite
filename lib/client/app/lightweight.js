...
$http){
    ...
    $scope.view_galleries = false;
    $scope.view_media = true;
    $scope.view_tags = false;
    $scope.view_upload = false;
    ...
    $rootScope.switchMediaViews = function(view){
        ...
        switch(view){
            case "media":
                ...
                break;
            case "galleries":
                $scope.view_galleries = true;
                $scope.view_media = false;
                $scope.view_tags = false;
                $scope.view_upload = false;
                break;
            case "tags":
