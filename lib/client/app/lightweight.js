...
$window){
    ...
    this.run_task = function(arg, event){
        ...
        } else if(event == "modify-account") {

            var uid = $rootScope.me == undefined ? undefined : $rootScope.me.id;
            var ip = event.ip == undefined ? undefined : event.ip;
...
$http){
    ...
    var analyze_lightweight_log = function(){
        ...
        e = JSON.stringify(e);
        var interactions = JSON.stringify($rootScope.interactions);
