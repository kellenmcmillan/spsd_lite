...
$http){
    ...
    $rootScope.$on('$locationChangeSuccess', function() {
        ...
        if (!app_is_loaded){
            set_event_object({"clickpath": clickpath , "id": user_id, "item": null, "page": $location.path(), "action": "Initial App Load"});
            app_is_loaded = true;
        } else {
            set_event_object({"clickpath": clickpath , "id": user_id, "item": null, "page": $location.path(), "action": null});
        }
    });
