...
$http){
    ...
    .then(function(result){
        ...
        $rootScope.current_media_vault_page = 0;
    ...
    $scope.paginate_media_list = function(arg){
        if(arg === 1){
            $rootScope.current_media_vault_page = $rootScope.current_media_vault_page + 1;
        } else if (arg === 0){
            $rootScope.current_media_vault_page = $rootScope.current_media_vault_page - 1;
        } else if (arg === -1){
            $rootScope.current_media_vault_page = 0;
        } else if (arg === 2) {
            $rootScope.current_media_vault_page = $rootScope.numberOfPages - 1;
        }
    }
