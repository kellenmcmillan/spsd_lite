...
$http){
    ...
    $rootScope.set_event_object = function(properties){
        $rootScope.event_object = properties;
    }
    // creates initial default event object
    $rootScope.set_event_object({"clickpath": clickpath , "id": user_id, "item": null, "page": $route.current, "action": "Page Load"});
    // tracks click path
