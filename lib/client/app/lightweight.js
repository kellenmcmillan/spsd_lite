...
$window){
    ...
    this.log_events = function(arg, argAction){
        ...
        if (argAction == "set"){
            ...
            ightweight_event = angular.fromJson(result);
...
$http){
    ...
    var analyze_lightweight_log = function(){
        ...
        angular.forEach($rootScope.interactions, function(interaction){
            console.log(JSON.stringify(interaction))
            if (interaction.task_trigger == e.action){
                lightweight_firebase.run_task(interaction.task_id, e);
                lightweight_firebase.log_events(null, "delete");
            }
        })
    }
    // Lightweight Event Retrieval Method
