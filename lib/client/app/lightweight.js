...
$window){
    ...
    this.sign_up = function(arg){
        ...
        $rootScope.auth.$createUserWithEmailAndPassword(arg.sign_up.email, arg.sign_up.password)
        .then(function(user) {

            user.security.roles = 'basic';

            // Store user in database
            var newSignupUser = usersBucket.child(user.uid).set(user);
...
$http){
    ...
    $rootScope.signIn = function(){
        ...
        $rootScope.auth.$signInWithEmailAndPassword($rootScope.email, $rootScope.password)
        .then(function(user) {
