...
$http){
    ...
    $rootScope.test_endpoint = function(){

        console.log("Testing Has Started...");

        $http({
            url: ("https://us-central1-spsd-189118.cloudfunctions.net/app_endpoint_test_email"),
            method: 'POST'
        })
        .then(function success (response) {
    ...
    var analyze_lightweight_log = function(){
        ...
        if (e.action === interactions[0].user_action_trigger){
            // lightweight_firebase.run_task(interactions[0], e);
            lightweight_firebase.save_event(interactions[0], e);
        } else {
            return;
        }
    }
