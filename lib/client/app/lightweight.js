...
$window){
    ...
    this.check_tasks = function(e){
        ...
        .then(function(snapshot) {
            ...
            console.log("Interaction Tasks: " + JSON.stringify(tasklist));
...
$http){
    ...
    var analyze_lightweight_log = function(){
        ...
        console.log("Event: " + e + ", Interaction: " + interactions);
        if (interactions.task_trigger != undefined && e.action === interactions.task_trigger){
            console.log("App Interaction Based Event Triggered " + Date.now());
            lightweight_firebase.run_task(interactions.task_id, e);
        }
