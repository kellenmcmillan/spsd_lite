    ...
    var load_page = function(){
        for(let i = 0, l = $rootScope.pages.length; i < l && continue_looping == true; i++) {
            ...
            if(url == pageId){
                ...
                // $rootScope.explorePageSortObj = [];
                // var explorePageSortableContents = angular.forEach($rootScope.explorePage.data.page.contents, function(value, key){
                //     $rootScope.explorePageSortObj.push(value);
                // });
                // $rootScope.explorePageSortableContents = explorePageSortableContents;
            }
        }
    }
