...
module.exports = function lightweightRouter(app) {
	...
	.get('*', function (request, response, next) {
		authorizationRoutingForUser(request, response, next);
	})
	...
	function authorizationRoutingForUser(request, response, next) {
		request.session.user ? hasBackendAccess(request, response, next) : noBackendAccess(request, response, next);
	}

	function noBackendAccess(request, response, next){
		var options = {
	...
	function hasBackendAccess(request, response, next){
		var options = {
