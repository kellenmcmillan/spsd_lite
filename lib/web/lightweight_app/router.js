...
module.exports = function lightweightRouter(app) {
	...
	function upload_media(request, response, next){
		...
		form.multiples = true;
		logger.log({ info:'Image Upload Fuction', message: 'Starting. heres the form ' + form });
		// store all uploads in the /uploads directory
		form.keepExtensions = true;
		form.uploadDir = "/app/lib/web/public/assets/uploads";
		logger.log({ info:'Image Upload Fuction', message: 'Directory ' + form.uploadDir});
		...
		form.on('file', function(field, file) {
			...
			logger.log({ info:'Image Upload Fuction', message: 'File Upload Is Working ' + file.path});
		});
