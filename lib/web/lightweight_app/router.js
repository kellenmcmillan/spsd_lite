...
module.exports = function lightweightRouter(app) {
	...
	function upload_media(request, response, next){
		...
		form.multiples = true;
		logger.log({ info:'Image Upload Fuction', message: 'Starting. file data: ' file });
		// store all uploads in the /uploads directory
		form.keepExtensions = true;
		form.uploadDir = "/app/lib/web/public/assets/temp";
		form.on('fileBegin', function (name, file){
	        fs.rename(file.path, '/app/lib/web/public/assets/uploads/' + file.name);
	    });
