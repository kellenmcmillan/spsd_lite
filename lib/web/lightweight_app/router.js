...
module.exports = function lightweightRouter(app) {
	...
	.put('/api/router/applab/update', function(request, response){
	...
	.put('/api/router/mediavault/put', function(request, response){
	...
	.put('/api/router/mediavault/:vault/update', function(request, response){
	...
	.put('/api/router/taskrunner/put', function(request, response){
	...
	.put('/api/router/taskrunner/:task/update', function(request, response){
	...
	.put('/api/router/uservault/put', function(request, response){
	...
	.put('/api/router/uservault/:vault/update', function(request, response){
	...
	.put('/api/router/storefront/put', function(request, response){
	...
	.put('/api/router/storefront/:product/update', function(request, response){
	...
	.get('/api/router/myvault/get', authenticationRequired, function(request, response){
	...
	.put('/api/router/myvault/put', function(request, response){
