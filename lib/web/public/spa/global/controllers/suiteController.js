...
filterFilter){
    ...
    var tmpGallerySortList = [];
    var itr;
    $rootScope.gallerySort = $rootScope.gallerySortObj;
    $rootScope.sortableOptions = {
        stop: function(e, ui) {
            itr = 1
            $rootScope.gallerySortObj = tmpGallerySortList.map(function(i){
                i.position = itr;
                itr ++;
                return i;
            });
        ...
        handle: '.list-handle',
        tolerance: 'pointer',
        containment: '.lightweight-list-control'
    };
