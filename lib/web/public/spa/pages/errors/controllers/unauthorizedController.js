...
var unauthorized = angular.module('unauthorized', ['directions', 'ngResource', 'ngAnimate', 'ngSanitize'])

.controller('unauthorizedController', ['$rootScope', '$scope', '$compile', '$window', function ($rootScope, $scope, $compile, $window){
