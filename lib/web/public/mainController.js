...
filterFilter){
    ...
    $scope.updateMedia = function($index){
        ...
        if($scope.updatedMedia.metadata.cover == null){
            $scope.updatedMedia.metadata.cover = false;
        }
        if($scope.updatedMedia.metadata.tags == null){
            $scope.updatedMedia.metadata.tags = null;
        }
        var tags = $scope.updatedMedia.metadata.tags;
        var cover = $scope.updatedMedia.metadata.cover;
        var newMetadata = {
            tags: tags,
            cover: cover
        };
