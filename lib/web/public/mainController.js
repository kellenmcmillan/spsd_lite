...
gallery_data){
    ...
    .then(function(result){
        ...
        $rootScope.miniAppName = app.settings.name;
        $rootScope.google_address_link = app.settings.address.google_address_link;
        $rootScope.trusted_google_address_widget_map = $sce.trustAsResourceUrl(app.settings.address.google_map);
        $rootScope.company_address_one = app.settings.address.street + ", " + app.settings.address.city +", " + app.settings.address.state + " " + app.settings.address.zipcode;
    });
...
.factory('app_settings', function($q){

    // Storage Init
    var realtimeDatabase = firebase.database();
    var appSettingsBucket = realtimeDatabase.ref().child('appSettings');
    // Storage Init
    var getData = function(){
        var defer = $q.defer();
        var data = {};
