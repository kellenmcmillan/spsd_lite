...
filterFilter){
    ...
    $rootScope.google_address_link = view_data[0].app_configs.google_address_link;
    $rootScope.trusted_google_address_widget_map = $sce.trustAsResourceUrl(view_data[0].app_configs.google_map_widget);
    $rootScope.company_address_one = view_data[0].app_configs.info.street + ", " + view_data[0].app_configs.info.city +", " + view_data[0].app_configs.info.state + " " + view_data[0].app_configs.info.zipcode;
