...
filterFilter){
    ...
    ////////////////////////////////// Firebase Methods
    $scope.updateMedia = function(image, index){
        if(image.cover == null){
            image.cover = false;
        }
        if(image.tags == null){
        ...
        mediaBucket.child(image.id).child("metadata").set(newMetadata);
        mediaBucket.child(image.id).once("value")
        .then(function(result){
            $scope.imagelist[index].cover = result.metadata.cover;
            $scope.imagelist[index].tags = result.metadata.tags;
        });
    }
    ////////////////////////////////// Firebase Methods
