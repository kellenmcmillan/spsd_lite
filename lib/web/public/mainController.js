...
gallery_data){
    ...
    $rootScope.miniAppName = $rootScope.settings.company_name;
    $rootScope.google_address_link = $rootScope.settings.address.google_address_link;
    $rootScope.trusted_google_address_widget_map = $sce.trustAsResourceUrl($rootScope.settings.address.google_map);
    $rootScope.company_address_one = $rootScope.settings.address.street + ", " + $rootScope.settings.address.city +", " + $rootScope.settings.address.state + " " + $rootScope.settings.address.zipcode;
