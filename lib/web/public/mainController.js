    ...
    $scope.updateApp = function(element){
        ...
        switch(element){
            case "mission":
                console.log(element);
                var elementData = {};
                elementData.mission.data.title = $rootScope.editable_mission.data.title;
                elementData.mission.data.subtitle = $rootScope.editable_mission.data.subtitle;
                elementData.mission.data.text = $rootScope.editable_mission.data.text[0];
                elementData.mission.data.images.source = $rootScope.editable_mission.data.images.source;
                data = elementData.mission;
                $rootScope.mission.data.title = elementData.mission.data.title;
                $rootScope.mission.data.subtitle = elementData.mission.data.subtitle;
                $rootScope.mission.data.text[0] = elementData.mission.data.text;
                $rootScope.mission.data.images.source = elementData.mission.data.images.source;
                appDataBucket.child("mission").update(data);
                break;
            case "parllaxOne":
