...
filterFilter){
    ...
    $scope.mission = {};
    $scope.mission.image = {};
    $scope.mission.image.source = "https://spsd-jc7noh2ropyhzv28kaix.stackpathdns.com/assets/uploads/landscape/landscapeConstruction4-landscape.jpg";
    ...
    $scope.selectMedia = function(){
        $scope.mission.image.source = $scope.mediaVaultSelect;
        $rootScope.media_vault_visible = false;
    }
    ////////////////////////////////// Data Manipulation
...
//         var locateUs = {};
//         var contactUs = {};
//         missionData.once('value')
//         .then(function(snapshot) {
//             console.log("mission data received");
//             var missionKey = snapshot.key;
//             var missionData = snapshot.val();
