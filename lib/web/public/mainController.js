...
filterFilter){
    ...
    $scope.updateUser = function(user){
        ...
        if(user.address.street){
            ...
            childDataValue.city = user.address.city;
            childDataValue.state = user.address.state;
            childDataValue.zipcode = user.address.zipcode;
        }
        if(user.role.alias){
            childDataValue.role = user.role.alias;
        }
    ...
    var getUsers = function(){
        ...
        .then(function(snapshot) {
            ...
            snapshot.forEach(function(childSnapshot) {
                ...
                if(childData.street){
                    childDataValue.address.street = user.street;
                    childDataValue.address.city = user.city;
                    childDataValue.address.state = user.state;
                    childDataValue.address.zipcode = user.zipcode;
                }
                if(childData.role){
    ...
    var getMe = function(id){
        ...
        .then(function(snapshot) {
            ...
            if(childData.address.street){
                childDataValue.address.street = user.address.street;
                childDataValue.address.city = user.address.city;
                childDataValue.address.state = user.address.state;
                childDataValue.address.zipcode = user.address.zipcode;
            }
