...
image_data){
    ...
    tag_data.getTags().then(function(result){
        if(result.length > 0){
            taglist.push(JSON.stringify(result));
            $scope.taglist = taglist;
            console.log("$scope.taglist value is " + JSON.stringify($scope.taglist));
        }
    });
    ...
    var getTags = function(){
        ...
        .then(function(snapshot) {
            ...
            snapshot.forEach(function(childSnapshot) {
                ...
                console.log('child found ' + childDataValue.tag);
                taglist.push(childDataValue.tag);
            });
            console.log(taglist);
