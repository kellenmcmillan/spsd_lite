    ...
    $scope.updateApp = function(element){
        ...
        switch(element){
            case "mission":
                console.log(element);
                var elementData = {};
                elementData.element.data.title = $rootScope.editable_mission.data.title;
                elementData.element.data.subtitle = $rootScope.editable_mission.data.subtitle;
                elementData.element.data.text = $rootScope.editable_mission.data.text[0];
                elementData.element.data.images.source = $rootScope.editable_mission.data.images.source;
                data = elementData.element;
                $rootScope.mission.data.title = elementData.element.data.title;
                $rootScope.mission.data.subtitle = elementData.element.data.subtitle;
                $rootScope.mission.data.text[0] = elementData.element.data.text;
                $rootScope.mission.data.images.source = elementData.element.data.images.source;
                break;
            case "parllaxOne":
