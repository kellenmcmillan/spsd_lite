        ...
        return new Promise(function (resolve, reject) {
            ...
            task.on('state_changed',
                ...
                function complete(snapshot){
                    ...
                    download.source = snapshot.downloadURL;
                    download.name = snapshot.metadata.name;
                    console.log("Here's the download url " + snapshot.downloadURL);
                    console.log("Here's the download name " + snapshot.metadata.name);
                    $scope.uploadedImages.push(snapshot);
                }
            );
        });
    }
