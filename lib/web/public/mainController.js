...
filterFilter){
    ...
    $scope.updateApp = function(element){
        ...
        switch(element){
            case "mission":
                var elementData = {};
                elementData.title = editable_mission.data.title;
                elementData.subtitle = editable_mission.data.subtitle;
                elementData.text = editable_mission.data.text;
                elementData.source = editable_mission.data.source;
                data = elementData;
                $rootScope.mission.data.title = elementData.title;
                $rootScope.mission.subtitle = editable_mission.data.subtitle;
                $rootScope.mission.text[0] = editable_mission.data.text;
                $rootScope.mission.source = editable_mission.data.source;
                break;
            case "parllaxOne":
