...
fromGalleriesDatabase){
    ...
    .then(function(result){
        ...
        $rootScope.page_index = 0;
        var page_number = angular.forEach(app.pages, function(value, key){
            $rootScope.pages[$rootScope.page_index].pageNumber = $rootScope.page_index;
            $rootScope.page_index++;
        });
