...
.factory('fromAppDatabase', function($q){
    ...
    var getData = function(){
        ...
        .then(function(snapshot) {
            ...
            app.mission = data["mission"];
            app.parallaxOne = data["parallaxOne"];
            app.featuredProducts = data["featuredProducts"];
            app.parallaxTwo = data["parallaxTwo"];
            app.parallaxThree = data["parallaxThree"];
            // going to index object
