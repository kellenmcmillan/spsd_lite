    ...
    $scope.updateApp = function(element){
        ...
        switch(element){
            case "mission":
                console.log(element);
                var elementData = {};
                elementData[JSON.stringify(element)].data.title = $rootScope.editable_mission.data.title;
                elementData[JSON.stringify(element)].data.subtitle = $rootScope.editable_mission.data.subtitle;
                elementData[JSON.stringify(element)].data.text = $rootScope.editable_mission.data.text[0];
                elementData[JSON.stringify(element)].data.images.source = $rootScope.editable_mission.data.images.source;
                data = elementData[JSON.stringify(element)];
                $rootScope.mission.data.title = elementData[JSON.stringify(element)].data.title;
                $rootScope.mission.data.subtitle = elementData[JSON.stringify(element)].data.subtitle;
                $rootScope.mission.data.text[0] = elementData[JSON.stringify(element)].data.text;
                $rootScope.mission.data.images.source = elementData[JSON.stringify(element)].data.images.source;
                break;
            case "parllaxOne":
        ...
        appDataBucket.child("/" + JSON.stringify(element)).update(data);
