...
uuid){
    ...
    .then(function(snapshot) {
        ...
        snapshot.forEach(function(childSnapshot) {
            ...
            var imageDownload = {};
            imageDownload.source = childData.downloadURL;
            imageDownload.filename = childData.metadata.name;
            console.log('image found ' + imageDownload.filename);
            $scope.mediaList.push(imageDownload);
        });
    });
            ...
            return new Promise(function (resolve, reject) {
                ...
                task.on('state_changed',
                    ...
                    function complete(){
                        ...
                        console.log("Here's the file url " + task.snapshot.downloadURL);
                        console.log("Here's the file name " + task.snapshot.metadata.name);
                    }
                );
            });
    ...
    .then(function(snapshot) {
        ...
        snapshot.forEach(function(childSnapshot) {
            ...
            $scope.taglist.push(JSON.stringify(childDataValue));
        });
    });
