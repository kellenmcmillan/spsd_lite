...
uuid){
    ...
    $rootScope.clearForm = function(form){
        $rootScope.taskAddObj = null;
        $rootScope.taskUpdateObj = null;
        $rootScope.indexForm = null;
        $rootScope.spotlightForm = null;
        $rootScope.projectForm = null;
        $rootScope.blogForm = null;
        form.$setPristine();
        form.$setUntouched();
    }
