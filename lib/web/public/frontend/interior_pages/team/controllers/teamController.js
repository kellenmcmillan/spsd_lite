...
.controller('teamController', ['$rootScope', '$scope', '$compile', '$window', 'staff', '$mdDialog', '$mdMenu', function ($rootScope, $scope, $compile, $window, staff, $mdDialog, $mdMenu){
   ...
   .error(function(err) { 
	...
	$rootScope.select_member = function(member){
		console.log(member);
		$rootScope.selected_member = member;
	}
	...
	// $scope.showTeamMember = function($event) {
	// 	$mdDialog.show({
	// 		controller: DialogController,
	// 		templateUrl: 'frontend/interior_pages/team/partials/staff.dialog.html',
	...
	//           $mdDialog.hide();
	//         }
	//         $scope.selected_member = $rootScope.selected_member;
	//     }
	// };
	...
	$scope.showPrerenderedDialog = function(ev) {
	    $mdDialog.show({
	     	...
	     	parent: angular.element(document.body),
	      	...
	      	controller: DialogController,
			fullscreen: true,
			locals: {staff_member: $rootScope.selected_member},
	    });
	    function DialogController($scope, $mdDialog, staff_member) {
		    $scope.staff_member = staff_member;
		}
	};
