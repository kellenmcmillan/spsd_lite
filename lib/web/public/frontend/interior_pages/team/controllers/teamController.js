...
var team = angular.module('team', ['ngResource', 'ngAnimate', 'ngSanitize', 'staffDataService'])

.controller('teamController', ['$rootScope', '$scope', '$compile', '$window', 'staff', '$mdDialog', '$mdMenu', function ($rootScope, $scope, $compile, $window, staff, $mdDialog, $mdMenu){
   ...
   .error(function(err) { 
	...
	$scope.member = function(member){
		console.log(member);
		return member;
		// $rootScope.$broadcast('member-selected', {
  //           data:{
  //               member: member,
  //           }
  //       });
    ...
    // $scope.showTeamMember= function showTeamMember($event) {
    //    var parentEl = angular.element(document.body);
    //    $mdDialog.show({
    //      parent: parentEl,
    //      targetEvent: $event,
    //      templateUrl: 'frontend/interior_pages/team/partials/staff.dialog.html',
	...
	$scope.showMember = function showMember($event) {
        $mdDialog.show({
        targetEvent: $event,
        template:
            '<md-dialog>' +
            '  <md-dialog-content>Hello {{ employee.name }}!</md-dialog-content>' +
            '  <md-dialog-actions>' +
            ...
            '  </md-dialog-actions>' +
            '</md-dialog>',
        controller: function GreetingController($scope, $mdDialog, employee) {
	...
	//       	preserveScope: true,
	// 		fullscreen: true,
	// 		locals: {staff_member: $scope.selected_member}
	//     });
	//     function DialogController($rootScope, $mdDialog) {
	// 	    $rootScope.$on('member-selected', function(event, args) {
	// 	    	console.log('got this far');
	// 	        $scope.staff_member = args.data.member;
	// 	    });
	// 	}
	// };
