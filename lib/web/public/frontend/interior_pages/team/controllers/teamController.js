...
var team = angular.module('team', ['ngResource', 'ngAnimate', 'ngSanitize', 'directions'])

.controller('teamController', ['$rootScope', '$scope', '$compile', '$window', function ($rootScope, $scope, $compile, $window){
