...
.controller('uxController', ['$rootScope', '$scope', '$compile', '$window', '$routeParams', '$mdDialog', '$mdMenu', '$timeout', 'Upload', function ($rootScope, $scope, $compile, $window, $routeParams, $mdDialog, $mdMenu, $timeout, Upload){
    ...
    $scope.upload = function upload_file(file) {
...
.directive('activated', function() {
    return {
        link: link,
        restrict: 'A'
      };
  function link(scope, element, attrs) {
    scope.$watch(attrs.activated, function(newVal, oldVal) {
