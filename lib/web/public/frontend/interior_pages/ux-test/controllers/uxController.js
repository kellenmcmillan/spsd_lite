...
.controller('uxController', ['$rootScope', '$scope', '$compile', '$window', '$routeParams', '$mdDialog', '$mdMenu', '$timeout', function ($rootScope, $scope, $compile, $window, $routeParams, $mdDialog, $mdMenu, $timeout){
    ...
    $scope.uploaded_image = {name: "wayneFerguson6", src: "https://spsd-jc7noh2ropyhzv28kaix.stackpathdns.com/assets/portfolios/wayne-ferguson-plaza/landscape/wayneFerguson6-landscape.jpg"};
