...
var uxTest = angular.module('uxTest', ['ngResource', 'ngAnimate', 'ngSanitize', 'ngMessages', 'fileReader'])

.controller('uxController', ['$rootScope', '$scope', '$compile', '$window', '$routeParams', '$mdDialog', '$mdMenu', '$timeout', 'ngFileSelect', "$http", function ($rootScope, $scope, $compile, $window, $routeParams, $mdDialog, $mdMenu, $timeout, ngFileSelect, $http){
