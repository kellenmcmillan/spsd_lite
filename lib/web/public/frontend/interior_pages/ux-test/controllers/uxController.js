...
.controller('uxController', ['$rootScope', '$scope', '$compile', '$window', '$routeParams', '$mdDialog', '$mdMenu', '$timeout', 'fileUpload', function ($rootScope, $scope, $compile, $window, $routeParams, $mdDialog, $mdMenu, $timeout, fileUpload){
    ...
    $scope.uploadFile = function(){
        ...
        var uploadUrl = "/api/upload/media";
