...
var home = angular.module('home', ['lightweightColor', 'scrollPosition', 'duScroll', 'slideshowDataService', 'indexServiceDataService', 'thirdParallaxDataService'])
...
.controller('homeController', [
    ...
    "index_service",
    "third_parallax_data", 
    function ($rootScope, $scope, $compile, $window, $interval, $timeout, $location, slideshow_data, index_service, third_parallax_data){
