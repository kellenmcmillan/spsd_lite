...
.controller('homeController', ['$rootScope', '$scope', '$compile', '$window', '$interval', '$timeout', function ($rootScope, $scope, $compile, $window, $interval, $timeout){
    ...
    $scope.$watch(function() {
      ...
      $scope.parallax_scroll = $scope.scroll;
    }, true);

    $scope.parallax_timeline = -$scope.parallax_scroll *.2;
    $scope.second_parallax_timeline = $scope.parallax_timeline + ($scope.window_height * 2);
