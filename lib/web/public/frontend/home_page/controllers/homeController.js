...
.controller('homeController', ['$rootScope', '$scope', '$compile', '$window', '$interval', '$timeout', 'app_data_service', function ($rootScope, $scope, $compile, $window, $interval, $timeout, app_data_service){
