...
var home = angular.module('home', ['lightweightColor', 'scrollPosition', 'duScroll', 'slideshowDataService', 'indexServiceDataService', 'firstParallaxDataService', 'thirdParallaxDataService'])
...
.controller('homeController', [
    ...
    "first_parallax_data",
    "third_parallax_data", 
    function ($rootScope, $scope, $compile, $window, $interval, $timeout, $location, slideshow_data, index_service, first_parallax_data, third_parallax_data){
    ...
    .success(function(data) { 
        ...
        $scope.primary_standard_container = first_parallax;
    }) 
    .error(function(err) { 
        console.log(err);
        return err; 
