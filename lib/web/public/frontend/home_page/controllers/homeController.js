...
var home = angular.module('home', ['lightweightColor', 'scrollPosition', 'duScroll', 'slideshowDataService', 'thirdParallaxDataService'])
...
.controller('homeController', [
    ...
    "slideshow_data", 
    "third_parallax_data", 
    function ($rootScope, $scope, $compile, $window, $interval, $timeout, $location, slideshow_data, third_parallax_data){
   ...
   .error(function(err) { 
    ...
    .success(function(data) { 
        ...
        slideshow_speed = slideshow_hero.content.lists[0].settigs.transition_speed;
