...
var home = angular.module('home', ['lightweightColor'])

.controller('homeController', ['$rootScope', '$scope', '$compile', '$window', '$interval', '$timeout', "ngParallax", function ($rootScope, $scope, $compile, $window, $interval, $timeout, app_data_service, ngParallax){
