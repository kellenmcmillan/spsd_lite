...
.controller('homeController', [
    ...
    "image_galleries",
    "third_parallax_data", 
    function ($rootScope, $scope, $compile, $window, $route, $interval, $timeout, $location, slideshow_data, index_service, first_parallax_data, image_galleries, third_parallax_data){
            ...
            if (gallery_details.featured == true){
                for(let c = 0, length = gallery.length; c < length; c++) {
                    ...
                    if(image.is_cover == true){
                        console.log('came and went here too');
                        var gallery_package = {};
