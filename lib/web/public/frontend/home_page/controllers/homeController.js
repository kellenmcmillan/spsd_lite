...
var home = angular.module('home', ['lightweightColor', 'scrollPosition', 'duScroll', 'thirdParallaxDataService'])

.controller('homeController', ['$rootScope', '$scope', '$compile', '$window', '$interval', '$timeout', "$location", "third_parallax_data", function ($rootScope, $scope, $compile, $window, $interval, $timeout, $location,third_parallax_data){
