...
.controller('homeController', ['$rootScope', '$scope', '$compile', '$window', '$interval', '$timeout', '$attrs', function ($rootScope, $scope, $compile, $window, $interval, $timeout, $attrs){
    ...
    $scope.second_offset = $scope.scroll + $window.innerHeight;
    $scope.third_offset = angular.element('.primary-gallery').$attrs.size + $window.innerHeight;
