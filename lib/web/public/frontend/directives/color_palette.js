...
.controller('colorController', ['$rootScope', '$scope', function ($rootScope, $scope){
    ...
    var color = { 
        ...
        base_lighter: {
            ...
            rgba_dark: "rgba(224, 224, 224, 0.5)"
        },
        base_normal: {
            hex: "#BDBDBD", 
            rgb: "rgb(189, 189, 189)",
            rgba_light: "rgba(189, 189, 189, 0.3)",
            rgba_dark: "rgba(189, 189, 189, 0.5)"
        },
        base_darker: {
            hex: "#757575", 
            rgb: "rgb(117, 117, 117)",
            rgba_light: "rgba(117, 117, 117, 0.3)",
            rgba_dark: "rgba(117, 117, 117, 0.5)"
        },
        base_darkest: {
            hex: "#424242", 
            rgb: "rgb(66, 66, 66)",
            rgba_light: "rgba(66, 66, 66, 0.3)",
            rgba_dark: "rgba(66, 66, 66, 0.5)"
        }
    }
    // dynamic data item pulled from site configuration
    ///////////////////////////////////////////////////
    ...
    $scope.base_hue_darkest_lightest_opacity = {name: "base-hlst opacity-lightest", value: color.base_darkest.rgba_light};
    $scope.base_hue_darkest_darkest_opacity = {name: "base-hdst opacity-darkest", value: color.base_darkest.rgba_dark};
