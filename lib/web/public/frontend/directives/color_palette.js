...
.controller('colorController', ['$rootScope', '$scope', function ($rootScope, $scope){
    ...
    var color = { 
        primary: {
            hex: "#388E3C", 
            rgb: "rgb(56, 142, 60)",
            rgba_light: "rgba(56, 142, 60, 0.6)",
            rgba_dark: "rgba(56, 142, 60, 0.9)"
        },
        primary_lighter: {
            hex: "#66BB6A", 
            rgb: "rgb(102, 187, 106)",
            rgba_light: "rgba(102, 187, 106, 0.6)",
            rgba_dark: "rgba(102, 187, 106, 0.9)"
        },
        base_lightest: {
            hex: "#F5F5F5", 
            rgb: "rgb(245, 245, 245)",
            rgba_light: "rgba(245, 245, 245, 0.6)",
            rgba_dark: "rgba(245, 245, 245, 0.9)"
        },
        base_lighter: {
            hex: "#E0E0E0", 
            rgb: "rgb(224, 224, 224)",
            rgba_light: "rgba(224, 224, 224, 0.6)",
            rgba_dark: "rgba(224, 224, 224, 0.9)"
        },
        base_normal: {
            hex: "#BDBDBD", 
            rgb: "rgb(189, 189, 189)",
            rgba_light: "rgba(189, 189, 189, 0.6)",
            rgba_dark: "rgba(189, 189, 189, 0.9)"
        },
        base_darker: {
            hex: "#757575", 
            rgb: "rgb(117, 117, 117)",
            rgba_light: "rgba(117, 117, 117, 0.6)",
            rgba_dark: "rgba(117, 117, 117, 0.9)"
        },
        base_darkest: {
            hex: "#424242", 
            rgb: "rgb(66, 66, 66)",
            rgba_light: "rgba(66, 66, 66, 0.6)",
            rgba_dark: "rgba(66, 66, 66, 0.9)"
        }
    }
    // dynamic data item pulled from site configuration
    ///////////////////////////////////////////////////
